    ...
    <Drawer anchor="right" classes={{ paper: classes.drawer }} onClose={onClose} open={open} variant="temporary">
      <form {...rest} className={clsx(classes.root, className)} onSubmit={handleSubmit}>
        ...
        <div className={classes.content}>
                ...
                <div className={classes.formGroup}>
                  <div className={classes.fieldGroup}>
                    <TextField
                      ...
                      variant="outlined"
                    />
                    <Button className={classes.addButton} onClick={handleTagAdd} size="small">
                  ...
                  <div className={classes.tags}>
                    {values.tags.map((tag) => (
                      <Chip key={tag} deleteIcon={<CloseIcon />} label={tag} onDelete={() => handleTagDelete(tag)} />
                    ))}
                  </div>
                </div>
                <div className={classes.formGroup}>
          ...
          <div className={classes.contentSection}>
            <div className={classes.contentSectionHeader} onClick={handleToggleCustomer}>
